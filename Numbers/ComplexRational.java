...
public class ComplexRational implements MyNumber<ComplexRational> {
    ...
    public ComplexRational divide(ComplexRational o) {
        if (o.equals(0)) {
            throw new ArithmeticException("ComplexRational divide(ComplexRational): Division by zero");
        }
    ...
    public ComplexRational divide(long o) {
        if (o == 0) {
           throw new ArithmeticException("ComplexRational divide(long): Division by zero");
        }
    ...
    public ComplexRational pow(int _ext) {
        if (this.equals(0) && _ext < 0) {
            throw new ArithmeticException("ComplexRational.pow(int): 0^x (x < 0) error");
        }
    ...
    public ComplexRational inverse() {
        if (this.equals(0)) {
            throw new ArithmeticException("ComplexRational.inverse(): 0^(-1) error");
        }
