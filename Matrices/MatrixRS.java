...
public class MatrixRS extends MatrixR {
    ...
    public MatrixRS(int _size) throws SizeOfMatrixException {
        super(_size, _size);
        det.assign(0);
    }
    ...
    public MatrixRS(MatrixR o) throws SizeOfMatrixException {
        super(o);
        if (o.sizeX != o.sizeY) {
           throw new SizeOfMatrixException("MatrixRS.(MatrixR): Instance of MatrixR is not square Matrix");
        }
    ...
    public Rational getDet() throws SizeOfMatrixException {
        this.evalRank();
    ...
    public MatrixRS inverse() throws SizeOfMatrixException{
        MatrixRS mat = new MatrixRS(this);
        mat.evalRank();

        if (mat.det.equals(0)) {
            throw new SizeOfMatrixException("MatrixRS.inverse(): determinant of matrix = 0");
        }
    ...
    public static MatrixRS getIdentity(int _size) throws SizeOfMatrixException{
        if (_size <= 0) {
            throw new SizeOfMatrixException("MatrixRS.getIdentity(int): size of matrix <= 0");
        }
